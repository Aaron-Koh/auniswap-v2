...
contract ZuniswapV2Pair is ERC20, Math {
    ...
    function mint(address to) public returns (uint256 liquidity) {
        ...
        uint256 amount0 = balance0 - reserve0_; // newly deposited amounts that haven’t yet been counted (saved in reserves)
        uint256 amount1 = balance1 - reserve1_; // newly deposited amounts that haven’t yet been counted (saved in reserves)
        ...
        _update(balance0, balance1, reserve0_, reserve1_); // saves balances to the reserve variables
