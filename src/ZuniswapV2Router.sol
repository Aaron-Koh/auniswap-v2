...
contract ZuniswapV2Router {
    ...
    function addLiquidity(
        address tokenA,
        address tokenB,
        uint256 amountADesired, // the amounts we want to deposit into the pair. These are upper bounds.
        uint256 amountBDesired, // the amounts we want to deposit into the pair. These are upper bounds.
        uint256 amountAMin,
        uint256 amountBMin,
        address to
    )
